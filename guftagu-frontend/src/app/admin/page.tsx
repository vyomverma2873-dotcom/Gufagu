...
import { 
  ...
  BarChart3, Clock, UserCheck, UserX, MessageSquare, Mail
} from 'lucide-react';
    ...
    <div className="min-h-[calc(100vh-4rem)] py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          ...
          <Link href="/admin/contact-queries" className="px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-white rounded-lg transition-colors">
