    ...
    <div className="min-h-[calc(100vh-4rem)] py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-neutral-900/80 backdrop-blur-xl border border-neutral-700/50 rounded-2xl p-8 shadow-lg">
          <p className="text-neutral-300 leading-relaxed">Our mission is to connect people worldwide through meaningful conversations, fostering understanding and building bridges across cultures and communities.</p>
        </div>
      </div>
    </div>
  );
